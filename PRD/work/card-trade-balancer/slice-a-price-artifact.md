...
Emit a committed, printing-level USD price artifact from the local Scryfall bulk source and add a lazy loader that fetches it only when the Trade Balancer first opens. (REQ-066, DEC-087, NFR-013)
