...
- Decisions: DEC-087 (feature), DEC-088 (printing-price artifact), DEC-089 (navigation menu)
...
| [B](slice-b-navigation-menu.md) | Top-level nav menu + mode switch | — | 1 | REQ-067, DEC-089, FLOW-010 |
