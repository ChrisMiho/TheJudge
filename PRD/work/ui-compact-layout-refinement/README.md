...
| Slice | File | Objective | Wave | Dependencies |
| --- | --- | --- | --- | --- |
| A | `slice-a-game-context-refinements.md` | Easter egg, merged turn-phase row, wider player buttons | 1 | None |
| B | `slice-b-zone-card-list-grid.md` | 2-column zone card grid, 4 visible then scroll | 1 | None |
| C | `slice-c-zone-scan-focused-ui.md` | Hide chrome while scanning; Exit on camera; drop manual-entry prompt | 1 | None |
| D | `slice-d-enrichment-list-scroll-cap.md` | View all cards: 4 rows per zone then scroll | 1 | None |
| E | `slice-e-layout-density-foundation.md` | Density prefs, theme toggle, `PageShell`, CSS tokens | 2 | None |
| F | `slice-f-slim-density-surfaces.md` | Slim overrides on high-scroll components | 3 | E |
| G | `slice-g-prd-promotion-and-ship-gates.md` | DEC/REQ promotion, integration tests, verification | 4 | A–F |
