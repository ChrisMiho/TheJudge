...
| [B](./slice-b-shard-frontend-coverage.md) | planned | Shard frontend coverage; merge blobs; thresholds on merged totals | sequential | A — needs the job structure and A's observed runner-core value to pick shard count |
