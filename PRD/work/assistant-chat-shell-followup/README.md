...
| [C](./slice-c-answered-fill-start-over-chrome.md) | Answered workspace fill + Start Over chrome (REQ-109) | done | none |
| [D](./slice-d-growing-pre-submit-composers.md) | Growing pre-submit question composers (REQ-110) | done | none |
...
All slices done. `/thejudge-cleanup PRD/work/assistant-chat-shell-followup/` (`$thejudge-cleanup` in Codex) once the PR merges.
