...
| [C](./slice-c-nav-and-diff-proof.md) | Verify the `PRD/README.md` Section Inventory row; prove the package-wide diff since its fork point touched nothing outside the licensed set. | none | done |
