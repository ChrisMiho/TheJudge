...
| B | Foil mode auto-selects from the printing's prices | — | — | planned |
| C | Pick the printing before the card is added (search path) | `trade-balancer/data/cardPrintingPrices.md` | A, B | planned |
| D | Printing picker becomes a scrollable, filterable box | `REQ-065`, `screen-layout.md` | A, B, C | planned |
