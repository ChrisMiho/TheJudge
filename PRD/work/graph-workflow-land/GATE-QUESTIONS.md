...
One sentence is reworded to say so. Step 7 of this flow ("the `define` gate
parks on any resulting `PRD/sections/` diff") is stale from an earlier package
and is left alone here, the same as FLOW-021's steps 3 and 6.
