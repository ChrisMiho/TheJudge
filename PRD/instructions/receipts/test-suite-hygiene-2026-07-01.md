...
- Status: shipped
- Backed by: NFR-012, DEC-085 (deps NFR-005, NFR-009)
...
- [x] Confirmed NFR-012 + DEC-085 already reflect shipped reality (no wording change needed)
...
- `PRD/sections/decisions/doc-process.md` — DEC-085
- `PRD/sections/decisions.md` — DEC-085 router index line
