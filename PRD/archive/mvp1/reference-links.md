...
- Active PRD control plane: `PRD/README.md`

## Retrieval Guidance
- Start with `PRD/archive/mvp1/README.md` for context.
- Use `key-decisions.md` when validating whether a change conflicts with MVP1 constraints.
- Use linked source docs for full implementation detail and historical rationale.
