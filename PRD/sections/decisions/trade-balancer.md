...
- Impact:
  ...
  - prices are whatever the source snapshot holds at build time; missing prices are stored as null/absent and handled per DEC-087 ($0 + caution indicator); the artifact records a **snapshot date** the UI may display
