...
- Notes:
  ...
  - superseded by DEC-107 for Quick Lookup's enrichment shape (question-driven core + System 3 always-on, with per-card enrichment layered in when a card is attached); the answer-seeded second-pass retrieval described here is deferred out of v1, not dropped, and is tracked as Q-004 for a dedicated future feature
