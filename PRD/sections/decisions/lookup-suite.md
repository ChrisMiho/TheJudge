...
- Impact:
  ...
  - a locked topic pill and an attached card are independent inputs and may both be present at submit time; the general-topics section's always-visible behavior applies regardless of card state
- Related requirements:
  - REQ-079
  - REQ-091
- Notes:
