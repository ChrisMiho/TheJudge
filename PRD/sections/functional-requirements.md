...
- Acceptance Criteria:
  ...
  - committed artifacts are gzipped, holding the full reviewed corpus in 11.3 MB rather than the 164 MB an uncompressed artifact would add; the loader decompresses on first read and retains its lazy-load behavior
