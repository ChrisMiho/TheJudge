...
- Status: shipped
- Summary: Submit orchestration that freezes context and carries conversation history, rendered through one shared chat-first `ConversationWorkspace` with retry/cooldown, a docked rounded-pill composer, an adaptive read-only context overlay, structured markdown assistant answers, and a browser-local resumable history drawer. Both In-Depth Question and Quick Question consume the same workspace rather than maintaining separate answered-state assemblies.
...
- Backed by: DEC-038, DEC-039, DEC-040, DEC-041, DEC-118, DEC-123, DEC-124, DEC-125, DEC-126, DEC-127, REQ-025, REQ-026, REQ-027, REQ-097, REQ-098, REQ-102, REQ-103, REQ-104, REQ-105, FLOW-016
...
- Status: shipped
- Summary: Browser-local, single-device conversation history (capped at 20, oldest pruned) auto-saves after each successful answer/follow-up. A left history drawer lists mode-filtered entries as plain unboxed rows; selecting one resumes frozen context, mode, and thread with follow-ups re-enabled. The History trigger is an icon zone in the Menu corner rail (DEC-126) on conversation-bearing destinations only. Below `768px` the drawer is a bottom sheet; at `768px`+ it is a left-edge drawer. Mutually exclusive with the feature-portal Menu drawer via `LeftEdgeDrawerContext`.
...
- Backed by: DEC-124, DEC-125, DEC-126, REQ-103, REQ-104, FLOW-016, DEC-103, NFR-001
...
- Backed by: DEC-089, DEC-095, DEC-104, DEC-109, DEC-110, DEC-111, DEC-117, DEC-120, DEC-122, DEC-126, REQ-045, REQ-067, REQ-089, REQ-090, REQ-096, REQ-100, FLOW-001, FLOW-010, NFR-001, NFR-006
