...
- MVP1: closed
- UX Wave 2: in progress — zone-based flow with user-flow refinements (see `PRD/work/user-flow-refinements/`)
- **Active implementation plan (agents):** `PRD/work/user-flow-gap-fixes/` — turn phase, card gate, enrichment ownership, alignment review
